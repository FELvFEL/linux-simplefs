...
1. При mount на vdb происходит OOM. В поле files используется calloc, что на большом диске может достигать нескольких десятков Мб. На это никакой памяти не хватит
2. После команды erase файлы остаются и можно продолжать писать в fs
3. При записи большей, чем размера файла зависает программа записи
